...
public class SolverShell {
	private static SolverShell instance; 
	...
	public void init() {
		...
		success_message.setMessage("Solve Success!");
		success_message.open();
		
	}
	
	public static synchronized SolverShell getSolverShell () {
		if(instance == null)
			instance= new SolverShell();
		return instance;
	}
