 ...
 * </p>
 * <ul>
 *   <li>{@link org.consensus.homodel.hOModel.impl.EqualityExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityExpressionImpl extends MinimalEObjectImpl.Container implements EqualityExpression
{
  ...
  {
    return HOModelPackage.Literals.EQUALITY_EXPRESSION;
  }
  ...
  public EList<RelationalExpression> getExp()
  {
    if (exp == null)
    {
      exp = new EObjectContainmentEList<RelationalExpression>(RelationalExpression.class, this, HOModelPackage.EQUALITY_EXPRESSION__EXP);
    }
    return exp;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HOModelPackage.EQUALITY_EXPRESSION__EXP:
